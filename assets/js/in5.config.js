...
var sliderSettings = {}, nav = {}, in5 = {layouts:[
 	{
 		...
 		"width": 425.196850393701,
 		"height": 368.503937007874,
 		"default": true,
 		"trigger": "default",
 		"index": 0
 	}
 ]},
viewOpts = ({title:0, page:1, zoom:1, fs:0, pdf:0, toc:0, thumbs:0, progress:0, showbar:1, bg:"transparent", loadText:"loading content...", footer:0});
...
function addNavProps(){
	if(nav.numPages === undefined) nav.numPages=299;
...
function getStartLayout(){
	...
	} else if(numLayouts === 2 && in5.layouts[1].trigger.match(/(portrait|landscape)/)){
